...
func TestIsNewer(t *testing.T) {
	tests := []struct {
		...
		{"lower major loses despite higher minor and patch", "2.0.0", "1.99.99", false},
		{"lower minor loses despite higher patch", "1.2.0", "1.1.99", false},
		{"lower patch loses", "1.2.3", "1.2.2", false},
