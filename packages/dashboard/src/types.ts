...
export interface Issue { id: string; identifier?: string; title: string; description: string; state: number; priority?: number; labels: string[]; url: string; branch_name?: string; blocked_by?: string[]; created_at?: string; updated_at?: string; tracker_meta: Record<string, unknown>; }
